...
lazy_static::lazy_static! {
    static ref CARD_DB: CardDatabase = CardDatabase::load_from_directory("data/cards/core_set")
        .expect("Failed to load card database");
    static ref DECK_REGISTRY: DeckRegistry = DeckRegistry::load_from_directory("data/decks")
