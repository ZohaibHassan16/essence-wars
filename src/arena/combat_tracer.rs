//! Combat keyword resolution tracing.
//!
//! Provides step-by-step visibility into how combat is resolved,
//! including keyword checks, damage calculations, and effects applied.
