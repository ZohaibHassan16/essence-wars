...
//!
//! Provides visibility into effect queue processing:
//! - Each effect queued with source and target
//! - Each effect executed and resulting state changes
//! - Queue depth and cascade chains
//! - Death triggers and their cascades

use crate::effects::{Effect, EffectSource, EffectTarget};
