...
generate_portrait() {
    ...
    echo -e "${YELLOW}[$id] Generating: $name${NC}"
    ...
    # Convert to WebP
    cwebp -q 95 "$OUTPUT_DIR/${id}.png" -o "$FINAL_DIR/${id}.webp"

    echo -e "${GREEN}[$id] Done: $FINAL_DIR/${id}.webp${NC}"
    echo ""
}
...
# 1056 - The High Artificer
generate_portrait 1056 "The High Artificer" \
...
# 1057 - The Sanctum Healer
generate_portrait 1057 "The Sanctum Healer" \
...
# 1058 - Siege Marshal Vex
generate_portrait 1058 "Siege Marshal Vex" \
...
# 1059 - The Grand Architect
generate_portrait 1059 "The Grand Architect" \
...
# 2060 - The Broodmother
generate_portrait 2060 "The Broodmother" \
...
# 2061 - Plague Sovereign
generate_portrait 2061 "Plague Sovereign" \
...
# 2062 - Alpha of the Hunt
generate_portrait 2062 "Alpha of the Hunt" \
...
# 2063 - The Eternal Grove
generate_portrait 2063 "The Eternal Grove" \
...
# 3055 - The Blood Sovereign
generate_portrait 3055 "The Blood Sovereign" \
...
# 3056 - Shadow Emperor Kael
generate_portrait 3056 "Shadow Emperor Kael" \
"Three-quarter view waist-up portrait of a regal male assassin-emperor commander, showing from head to waist as he emerges from living darkness. Ornate black armor with crimson trim covering his torso, shoulder plates, and gauntlets - geometric gothic patterns etched across every surface. Pale aristocratic features with sharp angular face, eyes that seem to pierce through shadows with cold calculation and imperial authority. Crown of black iron and crimson gems sitting on his head, marking his sovereignty over shadow. Both hands visible - one holding twin daggers that drip with void energy near his chest, the other extended in a lethal striking pose. His entire form subtly dissolving at the edges into darkness and shadow tendrils that writhe with malevolent life. Expression is regal yet ruthless, a ruler who commands through fear, precision, and the threat of instant death. Poised stance ready to vanish into shadow after delivering judgment. Gothic throne room with shadows bending unnaturally toward him, obeying his will in the background. Dramatic lighting with his face and armor emerging from darkness, crimson highlights from his crown, armor trim, and the gems pulsing with power. 90s Magic the Gathering card art, dark gothic portrait with noir atmosphere" \
"<lora:frazetta:0.5> <lora:classical-painting:0.5>"

# 3057 - The Shadow Weaver
generate_portrait 3057 "The Shadow Weaver" \
...
# 3058 - Void Archon
generate_portrait 3058 "Void Archon" \
...
echo "  Argentum:  1056, 1057, 1058, 1059"
echo "  Symbiote:  2060, 2061, 2062, 2063"
echo "  Obsidion:  3055, 3056, 3057, 3058"
echo ""
